...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'var(--bg-secondary)' }}>
      ...
      <main className="flex-1 flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-4xl space-y-8">
          ...
          >
            ...
            {/* Mobile Credits - Only visible on mobile */}
            <motion.div
              className="md:hidden flex items-center justify-center space-x-2 mt-4"
      ...
      {/* Footer - Logo and Credits - Hidden on mobile */}
      <motion.footer
        className="absolute bottom-4 right-4 hidden md:flex items-center space-x-2"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
